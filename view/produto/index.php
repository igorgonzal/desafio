		...
		<tbody>
			<?php foreach ($dados as $value) { ?>
				<tr>
					...
					<td> <?= $value->preco ?> </td>
					<td>
						<a href='<?= CAMINHO ?>produto/form.php?id=<?= $value->id ?>' style="color: #2980b9;"> <i class="fas fa-pencil-alt"></i></a>
						<a href='<?= CAMINHO ?>produto/delete.php?id=<?= $value->id ?>' style="color: #e74c3c;"> <i class="fas fa-trash"></i> </a>
					</td>
				</tr>
			<?php } ?>
		</tbody>
